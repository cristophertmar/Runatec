...
function ListarMenuPublicoSuccess(data) {
    ...
    if (data.length > 0) {
        ...
        //Solo aparece en el submenú mobile/responsive
        cadena = cadena + '<li id="li_mobile_home" style="display:none;"><a id="btn_descargaApp_mobile" href="https://mega.nz/file/FNkQiJ4A#HpO6uacKq6g7oNrqYxd4ajB29LE9bYRSlRD8OlrYbI4" target="_blank">¡Descarga el app!<i class="fas fa-mobile-alt" style="margin-left:10px;"></i></a></li>';
