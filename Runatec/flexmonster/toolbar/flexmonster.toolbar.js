...
FlexmonsterToolbar.prototype.init = function () {
    ...
    var createToolbar = function () {
        ...
        _this.listWrapper.id = "fm-list-wrapper";
    ...
    var enableToolbarScrolling = function () { //enables scrolling if possible
        if (_this.toolbar.scrollWidth - _this.toolbar.clientWidth > 0) {
            ...
            _this.leftScrollButton.id = "fm-left-scroll-button";
            _this.rightScrollButton = document.createElement("div");
            _this.rightScrollButton.id = "fm-right-scroll-button";
    ...
    window.addEventListener("resize", redrawToolbar);
}
...
FlexmonsterToolbar.prototype.showFormatCellsDialog = function (measureName) {
    ...
    negativeNumberRow.id = "fm-popup-format-cells-negative-number";
    var select = self.createSelect();
...
FlexmonsterToolbar.prototype.showDropdown = function (elem) {
    ...
    if (menu) {
        ...
        if (menuRect.right > toolbarRect.right - arrowWidth) {
            ...
            var luft = leftScrollArrow.getBoundingClientRect().right - menuRect.left + 5;
