...
$(document).ready(function () {
    ...
    if (nidPerfil == 3) {//si es productor mostrará los datos 
        ...
        $("input[type=checkbox]").change(function () {
            ...
            if (contador > 10) {
                alert("Puedes seleccionar hasta 10 Productos a la vez.");
...
function GraficarAnalisisPromedios(cadenaid, nidmercado, dfechainicio, dfechafin) {
    ...
    if (amplitud == 7) {
        if (evaluacadena == '/') {
            vurl = ".." + pathname + "Services/GraficarAnalisisPromediosSemanal";
        }
        else {
            var pathname = window.location.pathname;
            vurl = ".." + pathname + "/Services/GraficarAnalisisPromediosSemanal";
        ...
        if (evaluacadena == '/') {
            vurl = ".." + pathname + "Services/GraficarAnalisisPromediosQuincenal";
        }
        else {
            var pathname = window.location.pathname;
            vurl = ".." + pathname + "/Services/GraficarAnalisisPromediosQuincenal";
        ...
        if (evaluacadena == '/') {
            vurl = ".." + pathname + "Services/GraficarAnalisisPromediosMensual";
        }
        else {
            var pathname = window.location.pathname;
            vurl = ".." + pathname + "/Services/GraficarAnalisisPromediosMensual";
